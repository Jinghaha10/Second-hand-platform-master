...
import com.ssm.ex.PageNotFoundException;
import com.ssm.pojo.*;
import com.ssm.service.CarouselService;
...
public class HomeController {
    ...
    public ModelAndView Home(HttpServletRequest request) {
        ...
        try {
            ...
            //获取轮播图数据
            List<Carousel> carouselList = carouselService.selectCarouselByStatus(1);
            System.out.println("这是一个轮播信息：" + carouselList);
