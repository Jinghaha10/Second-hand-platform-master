...
import com.ssm.ex.PhoneNotFoundException;
import com.ssm.pojo.*;
...
public class AdminController {
    ...
    public @ResponseBody Map<String,Object> changeCarouselStatus(Integer id,Integer status){
    ...
    public @ResponseBody Map<String,Object> insertCarousel(String title,String imgUrl,String content,String link){
        ...
        Carousel carousel = new Carousel(1,title,sdf.format(new Date()),1,content,link,url);
