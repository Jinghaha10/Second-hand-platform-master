    ...
    <body>
        <div id="header">
            <div class="header-wrap">
                ...
                <ul class="nav fl">
                    <li><a href="/goods/index">二手交易平台</a></li>
                </ul>
            ...
            <div class="main-box fl" style="margin-left: 0px;">
                            ...
                            <c:forEach var="item" items="${carousel}">
                                <li style="display: list-item;">
                                    <a href="${item.url}" target="_blank">
                                        <img src="<%=basePath%>images/banner/${item.img_url}" alt="${item.title}" title="${item.title}"></a>
                                </li>
                            </c:forEach>
                        </ul>
                ...
                <div class="index-list">
                    <div class="list-header">
                        ...
                        <a href="/publish/publish" class="fr"><i class="icon"></i></a>
                    </div>
                    <div class="list-body">
                        <ul class="clearfix">
