...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header header header-demo" style="background: #0aa1ea">
        <div class="layui-main">
            ...
            <ul class="layui-nav" lay-filter="">
                <li class="layui-nav-item">
                    <img src="<%=basePath%>images/user/${admin.imgUrl}" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" height="35px" alt="">
                </li>
                <li class="layui-nav-item">
