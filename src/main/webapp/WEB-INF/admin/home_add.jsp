        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="title" name="title" required lay-verify="required"
                       autocomplete="off" class="layui-input title">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <div class="site-demo-upbar">
                    <input type="file" id="file" name="avatar" class="layui-upload-file change-picture" >
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <img id="LAY_demo_upload" name="imgUrl" width="200" src="" class="imgUrl">
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea id="content" name="content"
                          placeholder="简介" class="layui-textarea fly-editor content" style="height: 260px;"></textarea>
            </div>
