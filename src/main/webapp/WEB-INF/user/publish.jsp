...
<div id="header">
    <div class="header-wrap">
        <a href="/goods/index" class="logo fl">
            <img src="<%=basePath%>images/web/logo.jpeg" alt="logo">
            <h1>二手网</h1>
        </a>
        <ul class="nav fl">
        ...
        <div class="nav-right fr">
            <c:if test="${!empty cur_user}">
                <a href="/user/index" class="log-btn"><img src="<%=basePath%>images/user/${cur_user.imgUrl}"
        ...
        <div class="input-line image">
            <div class="layui-box layui-upload-button">
                <form target="layui-upload-iframe" key="set-mine" enctype="multipart/form-data">
                    <input type="file" name="info" lay-type="images" class="layui-upload-file info-img-upload">
<%--                    <input type="file" name="avatar" lay-type="images" class="change-picture" value="修改头像">--%>
        ...
        <div class="layui-form-item input-line">
            ...
            <div class="layui-input-inline">
                <select name="city" class="city">
                    ...
                    <option data-cid="1" value="1">成都大学</option>
        ...
        <div class="layui-form-item input-line">
            ...
            <div class="layui-input-inline" style="width: 390px;">
                <input type="text" name="title" autocomplete="off" placeholder="请输入 闲置名称"
        ...
        <div class="layui-form-item input-line" id="price">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" autocomplete="off" placeholder="请输入原价"
                       class="layui-input original-price">
            </div>
            <div class="layui-form-mid layui-word-aux">元　　　</div>
            <a href="javascript:;" class="add-original-link layui-btn layui-btn-small"><i class="layui-icon"
                                                                                          style="color: #fff;"></i>
                添加原购买链接</a>
            <a href="javascript:;" class="close-original-link layui-btn layui-btn-small layui-btn-danger"
               style="display: none;">关闭购买链接</a>
        </div>
        <div class="layui-form-item input-line" id="original-link" style="display: none;">
            <label class="layui-form-label">原购买链接</label>
            <div class="layui-input-block">
                <input type="text" name="title" autocomplete="off" placeholder="请输入原购买链接"
                       class="layui-input original-link">
            </div>
        </div>
        <div class="layui-form-item input-line">
            ...
            <div class="layui-input-inline">
                ...
                <div class="layui-unselect layui-form-select">
                    <div class="layui-select-title"><input type="text" placeholder="请选择分类" value="" readonly=""
                                                           class="layui-input layui-unselect"><i class="layui-edge"></i>
                    </div>
                    <dl class="layui-anim layui-anim-upbit">
        ...
        <div class="layui-form-item input-line">
            ...
            <div class="layui-input-block">
                <input type="radio" class="buyMethod" name="transactionMode" value="1" title="在线交易">
                <div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i><span>在线交易</span>
                </div>
                <input type="radio" class="buyMethod" name="transactionMode" value="2" title="线下交易">
                <div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i><span>线下交易</span>
                </div>
                <input type="radio" class="buyMethod" name="transactionMode" value="3" title="在线交易/线下交易"
                       checked="">
                <div class="layui-unselect layui-form-radio layui-form-radioed"><i
                        class="layui-anim layui-icon"></i><span>在线交易/线下交易</span></div>
            </div>
        </div>
        <div class="layui-form-item input-line" id="address">
            <label class="layui-form-label">交易地址</label>
            <div class="layui-input-block">
                <input type="text" name="title" autocomplete="off" placeholder="请输入交易地址"
        ...
        <div class="layui-form-item input-line" id="phoneNumber">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" autocomplete="off" placeholder="请输入手机号"
                       class="layui-input phone-number" value="${cur_user.phone}">
            </div>
            <label class="layui-form-label">QQ号</label>
            <div class="layui-input-inline">
                <input type="text" name="title" autocomplete="off" placeholder="请输入QQ号"
                       class="layui-input qq-number">
            </div>
            <label class="layui-form-label">微信号</label>
            <div class="layui-input-inline">
                <input type="text" name="title" autocomplete="off" placeholder="请输入微信号"
...
<div id="footer">
    ...
    <div class="footer-bottom-wrap">
        <div class="footer-bottom">
            ...
            <p class="tips">
                本站所有信息均为用户自由发布，本站不对信息的真实性负任何责任，交易时请注意识别信息的真假如有网站内容侵害了您的权益请联系我们删除</p>
            <p class="right">
